package sourabhkaushik.com.tech.credtask.boommenu.BoomButtons;
...
import sourabhkaushik.com.tech.credtask.boommenu.BMBShadow;
import sourabhkaushik.com.tech.credtask.boommenu.ButtonEnum;
...
public abstract class BoomButton extends FrameLayout {
    ...
    protected void initText(ViewGroup parent) {
        text = parent.findViewById(R.id.bmb_title);
        updateTextRect();
        updateTextPadding();
    ...
    public void updateSubText(String normalText){
        text=button.findViewById(R.id.bmb_sub_text);
        text.setText(normalText);
    }

    protected void initSubText(ViewGroup parent) {
        if (!containsSubText) return;
        subText = parent.findViewById(R.id.bmb_sub_text);
        updateSubTextRect();
    ...
    public void updateText(String normalText) {
        if (lastStateIsNormal) toNormalText();
        else toHighlightedText();
    }
